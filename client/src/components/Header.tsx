          ...
          <div className="container mx-auto px-4 flex justify-center">
            <div className="text-center">
              <h1 className="leading-tight">
                <span className="block text-8xl sm:text-9xl md:text-[8rem] lg:text-[10rem] xl:text-[12rem] font-darleston font-light text-gray-700 drop-shadow-lg" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>
                  At First Site
                </span>
