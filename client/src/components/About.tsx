...
export default function About() {
  ...
  return (
    <section ref={sectionRef} id="about" className="py-20 bg-gray-50 watercolor-bg relative" itemScope itemType="https://schema.org/AboutPage">
      {/* Mobile overlay to cover more of hero image */}
      <div className="absolute top-0 left-0 right-0 h-16 md:h-0 bg-gradient-to-b from-gray-50 via-gray-50/90 to-transparent -mt-16 md:mt-0"></div>
